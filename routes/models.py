...
class City(models.Model):
    ...
    city_feature_class = models.CharField(max_length=10, null=True, blank=True)
    city_feature_code = models.CharField(max_length=10, null=True, blank=True)
    city_country_code = models.CharField(max_length=2, null=True, blank=True)
    city_cc2 = models.CharField(max_length=60, null=True, blank=True)
    city_admin1_code = models.CharField(max_length=20, null=True, blank=True)
    city_admin2_code = models.CharField(max_length=20, null=True, blank=True)
    city_admin3_code = models.CharField(max_length=20, null=True, blank=True)
    city_admin4_code = models.CharField(max_length=20, null=True, blank=True)
